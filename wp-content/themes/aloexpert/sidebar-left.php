 ...
 * @@Modify Date: 2018-05-15 11:36:37
 * @@Function:
 */
...
if ( ! defined( 'ABSPATH' ) ) {
    ...
    if($is_product && is_active_sidebar('left-sidebar-detail')){
    	...
    	if(is_active_sidebar('left-sidebar-portfolio')){
	    	dynamic_sidebar('left-sidebar-portfolio');    		
    	}
    }else if(!is_front_page() && is_active_sidebar('left-sidebar')){
