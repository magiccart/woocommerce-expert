...
<div id="product-<?php the_ID(); ?>" <?php post_class(); ?> >
	...
	<div class="row">
		...
		<div class="product-info-main col-md-5 col-sm-6 col-xs-12">
	...
	<div class="list-service-box inner-list-service">
	    <div class="row">
	    	<div class="col-md-3 col-sm-3 col-xs-6 col-service">
	            <div class="service-box">
	                <div class="service-icon">
	                	<span class="flat-icon flaticon-transport">
	    	...
	    	<div class="col-md-3 col-sm-3 col-xs-6 col-service">
	            <div class="service-box">
	                <div class="service-icon">
	                	<span class="flat-icon flaticon-clock">
	                		<span class="hidden">hidden</span>
	                	</span>
	                </div>
	                <div class="service-info">
	    	...
	    	<div class="col-md-3 col-sm-3 col-xs-6 col-service">
	            <div class="service-box">
	                <div class="service-icon">
	                	<span class="flat-icon flaticon-money">
	                		<span class="hidden">hidden</span>
	                	</span>
	                </div>
	                <div class="service-info">
	    	...
	    	<div class="col-md-3 col-sm-3 col-xs-6 col-service">
	            <div class="service-box">
	                <div class="service-icon">
	                	<span class="flat-icon flaticon-technology">
	                		<span class="hidden">hidden</span>
	                	</span>
	                </div>
	                <div class="service-info">
