        ...
        <div class="product-img">
            ...
            <?php
                if( ( isset($args['quickview']) && $args['quickview'] ) || (!is_front_page() && !isset($args['quickview']) && $typeView != 'list-view' ) ){
                    ...
                    echo '<div class="quickview"><a href="#" class="button yith-wcqv-button"  title="' . esc_attr__('Quick View', 'aloexpert') . '" data-product_id="'. $post->ID .'"><i class="fa fa-search-plus icon-quickview"></i>' . __('Quick View', 'aloexpert') . '</a></div>';
                    }
                }
            ?>
        ...
        ?>
         ...
         <div class="info">
            <div class="information clearfix">
                ...
                ?>
                <?php
                    if( ( isset($args['statistic']) && $args['statistic'] )) :
                        global $alothemes;
