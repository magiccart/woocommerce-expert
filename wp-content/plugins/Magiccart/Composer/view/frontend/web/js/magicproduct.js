 ...
 * @@Modify Date: 2018-05-19 11:48:46
 * @@Function:
 */
 (function ($) {
    "use strict";
    $.fn.magicproduct = function (options) {
        var defaults = {
            ...
            classes  : '[class*="type-product"]', // Selector product grid
            tabs 	 : '.magictabs',
        ...
        *******************************/
            ...
            sendAjax : function(type, infotabs) {
				...
				$.ajax({
					type: 'post',
					data: { action: $loading.data('action'), context: 'frontend', type: type, info: infotabs },
					...
					success:function(data){
						...
						if($.fn.lazyload !== undefined){$("img.lazy").lazyload();}
					}
				});
            }, 
